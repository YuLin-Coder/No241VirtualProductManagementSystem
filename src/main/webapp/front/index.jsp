...
<html>
	...
	<style type="text/css">
		...
		#header .nav-top {
			...
			height: 68px;
			background: linear-gradient(270deg, #796BBF 0%, #A794FF 100%);
		...
		#header .navs {
			...
			box-sizing: border-box;
			height: 64px;
			background: linear-gradient(98deg, #F6EFFA 0%, #CBD2E0 100%, #E6EFFF 100%);
	...
	<body>
		...
		<div id="tabbar" v-if="true" class="tabbar" :style='{"padding":"30px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#000","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' style="position: relative;">
		  ...
		  <div style='box-sizing: border-box;' :style='{"padding":"0 0px","boxShadow":"0 0 6px rgba(110,22,64,.8)","margin":"0px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}' class="company"></div>
		  ...
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0px auto","borderColor":"rgba(255,255,255,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0px 0","width":"40%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}' class="desc"></div>
		</div>
