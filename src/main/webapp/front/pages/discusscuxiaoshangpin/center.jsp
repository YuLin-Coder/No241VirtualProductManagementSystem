				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px rgba(110,22,64,.0)","margin":"0 0 0 10px","borderColor":"rgba(110,22,64,.3)","backgroundColor":"rgba(248, 248, 248, 1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"rgba(248, 248, 248, 1)","borderRadius":"4px","borderWidth":"0 0 0px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"16px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}' class="layui-form-label">关联表id</label>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"rgba(248, 248, 248, 1)","borderRadius":"4px","borderWidth":"0 0 0px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"16px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}' class="layui-form-label">评论内容</label>
							<div class="layui-input-block input">
								<input type="text"  name="content" name="content" id="content" placeholder="评论内容" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"rgba(248, 248, 248, 1)","borderRadius":"4px","borderWidth":"0 0 0px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"16px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}' class="layui-form-label">回复内容</label>
							<div class="layui-input-block input">
