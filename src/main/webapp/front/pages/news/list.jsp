...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<!-- 标题 -->
			<div class="index-title" style="width: auto;" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(121, 107, 191, 1)","color":"rgba(249, 249, 249, 1)","borderRadius":"0","alignItems":"flex-start","borderWidth":"0 ","fontSize":"16px","borderStyle":"solid"}'>
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0px 0 0 0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"#fff","borderStyle":"solid"}'>
				...
				<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>标题</div>
						<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(121, 107, 191, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"0","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="title" id="title" placeholder="标题" autocomplete="off" class="layui-input">
					</div>
					<button :style='{"padding":"0 15px","boxShadow":"0 0 0px rgba(0,0,0,0)","margin":"0 0 0 10px","borderColor":"#409EFF","backgroundColor":"rgba(121, 107, 191, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"40px"}' id="btn-search" type="button" class="layui-btn layui-btn-normal">
						<i class="layui-icon layui-icon-search"></i>搜索
																				...
																				<div class="list news list5">
												<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" :style='{"padding":"0 12px 0 0 ","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 2% 10px 2%","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(248, 248, 248, 1)","borderRadius":"150px 0 0 150px","borderWidth":"0","width":"46%","borderStyle":"solid","height":"auto"}' class="list-item-body animation-box">
							<img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0 10px 0 0","borderColor":"rgba(232, 232, 232, 1)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"150px","borderWidth":"5px","width":"40%","borderStyle":"solid","height":"300px"}' :src="baseurl+item.picture">
							<div class="infos">
								<div class="title" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"24px","fontSize":"16px","borderStyle":"solid"}'>{{item.title}}</div>
								<div class="desc" :style='{"padding":"14px 0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(110, 110, 110, 1)","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"auto","fontSize":"14px","borderStyle":"solid"}'>{{item.introduction}}</div>
								<div class="tag" :style='{"padding":"0 12px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(123, 98, 242, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"90px","lineHeight":"24px","fontSize":"12px","borderStyle":"solid"}'>新闻动态</div>
							</div>
						</div>
					</div>
