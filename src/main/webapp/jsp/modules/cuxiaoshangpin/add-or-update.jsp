		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑促销商品</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>促销商品管理</span></li>
								<li class="breadcrumb-item active"><span>编辑促销商品</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">促销商品信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>商品规格</label>
										<input name="shangpinguige" id="shangpinguige" name="shangpinguige" class="form-control" placeholder="商品规格">
									</div>
									<div class="form-group col-md-6">
										<label>商品简介</label>
										<textarea  name="shangpinjianjie" class="form-control" id="shangpinjianjie" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>生产地</label>
										<input name="shengchandi" id="shengchandi" name="shengchandi" class="form-control" placeholder="生产地">
									</div>
									<div class="form-group col-md-6">
										<label>原材料</label>
										<input name="yuancailiao" id="yuancailiao" name="yuancailiao" class="form-control" placeholder="原材料">
									</div>
									<div class="form-group col-md-6">
										<label>上架日期</label>
									...
									<div class="form-group col-md-6">
										<label>倒计结束</label>
										<div id="reversetimeDate" class="input-append date form_datetime">
											<input name="reversetime" size="15"  type="text" value="" readonly>
											<span class="add-on"><i class="icon-remove"></i></span>
											<span class="add-on"><i class="icon-calendar"></i></span>
										</div>
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "cuxiaoshangpin/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("cuxiaoshangpin/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("cuxiaoshangpin/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("cuxiaoshangpin/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#reversetimeDate").datetimepicker({ 
				autoclose: true,
				format:'yyyy-mm-dd hh:ii:ss',
				minuteStep:1,
				language:'zh-CN',
		...
		function calculationSE(colName){
			//单列求和接口
			http("cuxiaoshangpin"+colName,"GET",{
				tableName: "cuxiaoshangpin",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shangpintupian != null && res.data.shangpintupian != ''){
						...
						$("#shangpintupianImg").attr("src",baseUrl+res.data.shangpintupian);
